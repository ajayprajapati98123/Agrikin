...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] bg-stone-100 dark:bg-emerald-950 py-10 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="max-w-5xl w-full bg-white dark:bg-emerald-900/60 rounded-3xl shadow-2xl border border-stone-200 dark:border-emerald-800 overflow-hidden grid grid-cols-1 lg:grid-cols-12">
        {/* Left: Indian Farmer Illustration & Agricultural Scenery */}
        <div className="lg:col-span-5 bg-gradient-to-br from-emerald-900 via-emerald-800 to-green-900 p-8 sm:p-10 text-white flex flex-col justify-between relative overflow-hidden">
          ...
          {/* Farmer Artwork Card */}
          <div className="relative z-10 my-8 bg-emerald-950/70 border border-emerald-500/30 rounded-2xl p-4 backdrop-blur-md space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-emerald-300">Ludhiana, Punjab</div>
                <div className="text-[10px] text-yellow-300 font-semibold mt-0.5">🌾 Organic Basmati & Wheat</div>
              </div>
            </div>
          ...
          <div className="relative z-10 text-[11px] text-emerald-300 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 rounded-xl border border-stone-200 dark:border-emerald-800 bg-stone-50 dark:bg-emerald-950 text-stone-900 dark:text-stone-100 focus:ring-2 focus:ring-emerald-600 focus:outline-none"
                >
                  ...
                  <button
                    ...
                    className={`py-2 px-2 text-center rounded-xl border font-semibold transition-all ${
                      formData.role === r.id
                        ...
                        : "bg-stone-50 dark:bg-emerald-950 text-stone-700 dark:text-stone-300 border-stone-200 dark:border-emerald-800"
                    }`}
                  >
                    {r.label}
                  </button>
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 rounded-xl border border-stone-200 dark:border-emerald-800 bg-stone-50 dark:bg-emerald-950 text-stone-900 dark:text-stone-100 focus:ring-2 focus:ring-emerald-600 focus:outline-none"
                />
                <button
                  type="button"
              ...
              <div className="flex flex-wrap gap-1.5">
                {formData.crops.map((c) => (
                  <span
                    key={c}
                    className="inline-flex items-center gap-1 bg-emerald-100 dark:bg-emerald-900 text-emerald-900 dark:text-emerald-100 px-2.5 py-1 rounded-lg font-medium"
                  >
                    {c}
                    <button
                      type="button"
