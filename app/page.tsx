        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-8 rounded-3xl bg-[#FFFEFD] dark:bg-[#083344] border border-[#EAE3D5] dark:border-cyan-800/60 shadow-xs hover:shadow-xl hover:border-cyan-300 transition-all flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-[#FAF7F0] dark:bg-cyan-950/40 border border-[#EAE3D5] dark:border-cyan-800/60 space-y-2 text-xs">
                <div className="flex items-center justify-between font-semibold">
                  <span className="text-stone-800 dark:text-stone-200">Gurpreet Singh (Ludhiana)</span>
                  <span className="text-cyan-700 dark:text-cyan-400 font-bold">4.5 km away</span>
                </div>
            ...
            <div className="pt-6">
              <Link
                href="/krishi-connect"
                className="inline-flex items-center gap-2 text-sm font-bold text-cyan-800 dark:text-cyan-300 hover:text-cyan-600 transition-colors"
              >
          ...
          <div className="p-8 rounded-3xl bg-[#FFFEFD] dark:bg-[#083344] border border-[#EAE3D5] dark:border-cyan-800/60 shadow-xs hover:shadow-xl hover:border-cyan-300 transition-all flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 text-center text-xs">
                <div className="p-2.5 rounded-xl bg-cyan-50 dark:bg-cyan-950/40 font-semibold text-cyan-900 dark:text-cyan-200 border border-cyan-200 dark:border-cyan-800">
                  🌱 Crop Disease
                </div>
                <div className="p-2.5 rounded-xl bg-amber-50 dark:bg-amber-950/30 font-semibold text-amber-900 dark:text-amber-200 border border-amber-200 dark:border-amber-800">
                  🥕 Produce Grade
                </div>
                <div className="p-2.5 rounded-xl bg-teal-50 dark:bg-teal-950/30 font-semibold text-teal-900 dark:text-teal-200 border border-teal-200 dark:border-teal-800">
                  🧪 Soil Health
                </div>
              </div>
            </div>
