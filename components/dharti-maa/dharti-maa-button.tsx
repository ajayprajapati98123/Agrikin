    ...
    <>
      ...
      <div className="fixed bottom-6 left-6 z-40 flex items-center gap-3">
        <button
          ...
          className="group relative flex items-center gap-2.5 bg-gradient-to-r from-emerald-800 via-emerald-700 to-green-700 hover:from-emerald-700 hover:to-green-600 text-white pl-2 pr-4 py-2 rounded-full shadow-xl shadow-emerald-950/30 border-2 border-emerald-400/60 hover:border-yellow-300 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer focus:outline-none focus:ring-4 focus:ring-emerald-400/40"
        ...
        >
          ...
          <div className="relative">
            ...
            <span className="absolute -top-1 -right-1 flex h-3 w-3">
              ...
              <span className="relative inline-flex rounded-full h-3 w-3 bg-yellow-400 border border-emerald-900"></span>
            </span>
          </div>

          <div className="text-left">
            <div className="flex items-center gap-1 font-bold text-sm leading-tight text-white group-hover:text-yellow-200 transition-colors">
